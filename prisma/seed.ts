...
const DEVICES: DeviceSeed[] = [
  ...
  { slug: 'iphone-16', nombre: 'iPhone 16', generacion: '16', altoMm: 150.6, anchoMm: 74.6, cam: { x: 4, y: 4, w: 35, h: 40 }, moduloForma: 'vertical' },
  { slug: 'iphone-16-plus', nombre: 'iPhone 16 Plus', generacion: '16', altoMm: 163.9, anchoMm: 80.8, cam: { x: 4, y: 4, w: 36, h: 42 }, moduloForma: 'vertical' },
